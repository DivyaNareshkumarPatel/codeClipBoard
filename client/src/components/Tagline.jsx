    ...
    return (
        <div className="Tagline">
            ...
            <motion.div
                ...
                className="text"
            >
                Unlock your creativity with our platform: effortlessly write, edit,
                and preview HTML, CSS, and JavaScript code. Transform your ideas into
                interactive web experiences and a user-friendly interface.
            </motion.div>
        </div>
    );
}
